...
cti = data_sst["sst"][:,cti_lat_sel,cti_lon_sel] - 273.15
...
# Final dataset
sst_fin = sst_cti[1:nt-1,:,:]
uwd_fin = uwd_mmv[1:nt-1,:,:]
vwd_fin = vwd_mmv[1:nt-1,:,:]
...
# Exporting index as time series
df = pd.DataFrame({
    "time" : sst_fin["time"].values,
    "amm"  : sst_mca,
})
