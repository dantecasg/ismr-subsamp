...
# ╔═╡ b021858c-df22-44c2-b46f-381ce6f98c91
md"### Loading data"
...
# ╔═╡ fc5cb842-a7f8-4b3c-9057-f3dce9cec4ac
# Normalizing
for i in 1:6
...
# ╔═╡ 5e2f2cc0-e768-40fa-a1ff-9b38d1a6f1cb
md"### Atlantic Meridional Mode"

# ╔═╡ 00004a5d-3c30-4798-8798-3c20966e7c17
begin
	# Observed
...
# ╔═╡ 1d9505c4-e1b1-4eb6-ab92-d35e56fa7e7e
# Normalizing
for i in 1:6
...
Correlation graphs wit ONI are doing step-by-step because a time missmatch (ONI observations only have 35 elements whereas the other time series have 36 elements).

`anlTot` summarizes all these steps in one function, which is applied to the rest of indexes.
...
# ╔═╡ 844031ae-2886-443a-a413-39c4e7df6001
g_dmi_cor = anlTot(
...
# ╔═╡ e812a68e-ba6d-4cbc-bbb6-e24645ccb9f8
md"""
### Corr. with AMM
"""

# ╔═╡ 7f748010-b475-4913-889b-e157dd197029
g_amm_cor = anlTot(
	obs_ts  = pre_obs_ts_anom, 
	asm_ts  = pre_asm_ts_anom,
	obs_idx = amm_obs, 
...
# ╔═╡ 4cb4ad40-65cf-4434-b9af-78a4280117a8
